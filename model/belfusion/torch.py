        ...
        for name, param in module.named_parameters():
            if "bias" in name:
                ...
                if isinstance(module, nn.LSTMCell) or isinstance(module, nn.LSTM):
                    ...
                    start, end = n // DIV, n // 2
                    param.data[start:end].fill_(1.0)  # to remember more by default
                    ...
                    param.data[:end].fill_(-1.0)  # to remember more by default
            elif "weight" in name:
                nn.init.xavier_normal_(param)
                if (
                    isinstance(module, nn.LSTMCell)
                    ...
                    if "weight_ih" in name:  # input -> hidden weights
                        ...
                        for idx in range(DIV):
                            ...
                            )  # orthogonal initialization https://arxiv.org/pdf/1702.00071.pdf
    else:
